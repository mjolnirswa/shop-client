...
import {
  $boilerManufactures,
  $partsManufactures,
  setBoilerManufacturesFromQuery,
  setPartsManufacturesFromQuery,
...
const CatalogFilters = ({
  ...
  const boilerManufacturers = useStore($boilerManufactures)
    ...
    try {
      ...
      if (isValidBoilerQuery && isValidPartsQuery && isValidPriceQuery) {
        updateParamsAndFiltersFromQuery(() => {
          ...
          setBoilerManufacturesFromQuery(boilerQueryValue)
          setPartsManufacturesFromQuery(partsQueryValue)
